...
smiData.RigidTransform(1).ID = "B[MQ+E9aE7zHVcSUSfx:-:MHTNeriU5q9t/6QZw]";
...
smiData.RigidTransform(2).ID = "F[MQ+E9aE7zHVcSUSfx:-:MHTNeriU5q9t/6QZw]";
...
smiData.RigidTransform(3).ID = "B[MQ+E9aE7zHVcSUSfx:-:Mqi0gUTqw8DNlfyA1]";
...
smiData.RigidTransform(4).ID = "F[MQ+E9aE7zHVcSUSfx:-:Mqi0gUTqw8DNlfyA1]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(5).translation = [0 -22.5 185];  % mm
smiData.RigidTransform(5).angle = 0;  % rad
smiData.RigidTransform(5).axis = [0 0 0];
smiData.RigidTransform(5).ID = "SixDofRigidTransform[Mqi0gUTqw8DNlfyA1]";
...
smiData.RevoluteJoint(1).ID = "[MQ+E9aE7zHVcSUSfx:-:MHTNeriU5q9t/6QZw]";

smiData.RevoluteJoint(2).Rz.Pos = 0;  % deg
smiData.RevoluteJoint(2).ID = "[MQ+E9aE7zHVcSUSfx:-:Mqi0gUTqw8DNlfyA1]";
